...
namespace gl
{
	...
	static void CODEGEN_FUNCPTR Switch_TexturePageCommitmentEXT(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLboolean commit)
	{
		TexturePageCommitmentEXT = (PFNTEXTUREPAGECOMMITMENTEXTPROC)IntGetProcAddress("glTexturePageCommitmentEXT");
		TexturePageCommitmentEXT(texture, level, xoffset, yoffset, zoffset, width, height, depth, commit);
	}
	...
	namespace sys
	{
		namespace 
		{
			...
			{
				MapEntry *tableEnd = &g_mappingTable[4];
		...
		void CheckExtensions()
		{
			...
			std::for_each(&g_mappingTable[0], &g_mappingTable[4], ClearEntry());
